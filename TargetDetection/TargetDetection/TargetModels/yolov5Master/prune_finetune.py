    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                ...
                loss, loss_items = compute_loss_cfg(pred, targets.to(device), model)  # loss scaled by batch_size
                if rank != -1:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5s_v3.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/letter.yaml', help='data.yaml path')
