...
class HANDDataSet(Dataset):
    ...
    def __init__(self, voc_root, transforms, year='hand', train_set='train.txt'):
        self.root = os.path.join(voc_root, "HAND", year)
        self.img_root = os.path.join(self.root, "JPEGImages", train_set.split('.')[0])
        self.annotations_root = os.path.join(self.root, "Annotations", train_set.split('.')[0])
        ...
        # read class_indict
        try:
            json_file = open('./hand_classes.json', 'r')
